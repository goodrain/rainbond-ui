...
export default class ImportMessage extends PureComponent {
    ...
    checkIfEmpty = (data) => {
        ...
        return false; // At least one object is not empty
    }
    render() {
        const {
            match: {
        ...
        const disable = this.checkIfEmpty(successArr)
        return (
            <PageHeaderLayout
                    ...
                    >
                        ...
                        {resourceData && Object.keys(resourceData).map((item, index) => {
                            ...
                            <Row style={{ textAlign: 'center' }}>
                                <Button type="primary" onClick={this.onNext} style={{ marginLeft: '120px', padding: '0px 36px' }} disabled={disable}>
