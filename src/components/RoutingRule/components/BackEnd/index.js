...
class DAinputs extends Component {
    ...
    render() {
        const { editState, removeShow, ports } = this.props
        ...
        ports
            .map(group => (
                        <Option key={group.service_name} value={group.service_name}>
                            {group.service_name}
                        ...
                        <Row key={index} className={styles.RowStyle}>
                            <Card style={{ width: '100%' }}>
                                <Col span={22}>
                                    <Row>
                                        <Col span={8}>
                                            <span style={spanStyle}>{Svg}{formatMessage({ id: 'teamGateway.DrawerGateWayAPI.BackEnd.Internal' })}：</span>
                                        </Col>
                                        <Col span={16}>
                                            <AutoComplete
                                                onChange={ e=>
                                                ...
                                                dataSource={options}
                                                value={item.name}
                                                placeholder={formatMessage({id:'teamGateway.DrawerGateWayAPI.BackEnd.input_Internal'})}
