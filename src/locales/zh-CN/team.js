...
const teamAdd = {
  ...
  'teamAdd.create.upload.chunkUnsupported': '当前集群暂不支持大文件分片上传',
  'teamAdd.create.upload.finishBeforeSubmit': '请先完成镜像文件上传再创建虚拟机',
...
const teamGateway = {
  ...
  'teamGateway.certificate.desc':'TLS 证书管理，支持手动上传服务端证书和客户端认证 CA。',
  ...
  'teamGateway.certificate.table.type':'证书用途',
  'teamGateway.certificate.table.info':'证书信息',
  ...
  'teamGateway.certificate.clientCA':'客户端 CA',
  'teamGateway.certificate.clientCA.add':'添加客户端 CA',
  'teamGateway.certificate.clientCA.edit':'编辑客户端 CA',
  'teamGateway.certificate.clientCA.content':'客户端 CA 证书',
  'teamGateway.certificate.clientCA.content.required':'请填写或上传客户端 CA 证书',
  'teamGateway.certificate.clientCA.subject':'CA 主题',
  'teamGateway.certificate.clientCA.boundDomains':'绑定域名',
  'teamGateway.certificate.purpose':'证书用途',
  'teamGateway.certificate.server':'服务端证书',
  'teamGateway.certificate.purpose.server.desc':'用于网关向访问方证明身份，需要上传证书和私钥。',
  'teamGateway.certificate.purpose.clientCA.desc':'用于验证访问方的客户端证书，只需上传 CA 公钥证书；客户端证书和私钥由调用方保管。',
  'teamGateway.mtls.title':'双向认证',
  'teamGateway.mtls.config':'配置 mTLS',
  'teamGateway.mtls.enabled':'已开启',
  'teamGateway.mtls.disabled':'未开启',
  'teamGateway.mtls.clientAuth':'客户端证书认证',
  'teamGateway.mtls.clientCA':'受信任客户端 CA',
  'teamGateway.mtls.clientCA.placeholder':'请选择客户端 CA',
  'teamGateway.mtls.clientCA.required':'开启双向认证前请选择客户端 CA',
  'teamGateway.mtls.warning':'开启后，该域名下所有路径都必须携带由所选 CA 签发的有效客户端证书。',
  ...
  'teamNewGateway.NewGateway.AutomaticIssuance.manualIssue': '手动上传',
...
const teamManage = {
  ...
  'teamManage.tabs.image.table.scope':'级别',
...
const teamOther = {
  ...
  'teamOther.manage.title':'配置文件和持久化存储',
  'teamOther.manage.config_file_title':'配置文件',
  'teamOther.manage.persistent_storage_title':'持久化存储',
  'teamOther.manage.name':'名称',
  'teamOther.manage.path':'挂载路径',
  'teamOther.manage.type':'存储类型',
  'teamOther.manage.share':'持久化存储',
  'teamOther.manage.add_file':'配置文件',
  'teamOther.manage.storage_class':'存储类型',
  'teamOther.manage.capacity':'容量(Gi)',
  'teamOther.manage.access_mode':'访问模式',
  'teamOther.manage.add_config_file':'新增配置文件',
  'teamOther.manage.add_storage':'新增持久化存储',
  'teamOther.manage.add_persistent_storage':'新增持久化存储',
...
const Vm = {
  ...
  'Vm.createVm.modalDesc': '统一支持公共镜像、链接下载、文件上传和本地镜像四种来源，并保持与镜像容器一致的创建体验。',
  ...
  'Vm.createVm.assetCount': '共 {count} 个可用本地镜像。',
  'Vm.createVm.runtimeConfig': '运行配置',
  'Vm.createVm.runtimeConfigDesc': '按集群能力选择架构、GPU 直通、USB 透传与网络参数，不需要的能力可以保持关闭。',
  'Vm.createVm.gpuDesc': '为虚拟机开启 GPU 直通，并在下方选择可用的 GPU 资源。',
  ...
  'Vm.createVm.vm':'虚拟机',
  'Vm.createVm.gpu': 'GPU 直通',
  'Vm.createVm.gpuResources': 'GPU 资源',
  'Vm.createVm.gpuResourcesPlaceholder': '请选择 GPU 资源',
  'Vm.createVm.gpuResourcesRequired': '开启 GPU 直通后必须选择 GPU 资源',
  'Vm.createVm.gpuCount': 'GPU 卡数量',
  'Vm.createVm.gpuCountRequired': '开启 GPU 直通后必须填写 GPU 卡数量',
  'Vm.createVm.gpuCountSingleResourceOnly': 'GPU 卡数量大于 1 时只能选择 1 种 GPU 资源',
  'Vm.createVm.usb': 'USB 透传',
  'Vm.createVm.usbResources': 'USB 资源',
  'Vm.createVm.usbResourcesPlaceholder': '请选择 USB 资源',
  'Vm.createVm.usbResourcesRequired': '开启 USB 透传后必须选择 USB 资源',
  'Vm.createVm.cloneSource': '复制来源',
  'Vm.createVm.cloneSourcePlaceholder': '请选择要复制的已有镜像',
  'Vm.createVm.selectLiveMigrationStorage': '请选择虚拟机存储类型',
  'Vm.createVm.noLiveMigrationStorage': '当前团队没有可用于虚拟机的存储类型',
  'Vm.createVm.noLiveMigrationStorageHint': '当前团队暂无可用存储类型。',
  'Vm.assetCatalog.manage': '本地镜像',
  'Vm.assetCatalog.title': '本地镜像',
  'Vm.assetCatalog.total': '当前显示 {count} 项，共 {total} 个本地镜像',
  'Vm.assetCatalog.name': '本地镜像名称',
  'Vm.assetCatalog.source': '来源',
  'Vm.assetCatalog.sourceUnknown': '未知来源',
  'Vm.assetCatalog.archFormat': '架构 / 格式',
  'Vm.assetCatalog.size': '大小',
  ...
  'Vm.assetCatalog.detailTitle': '本地镜像详情',
  'Vm.assetCatalog.searchPlaceholder': '按名称、来源或状态搜索',
  'Vm.assetCatalog.empty': '暂无本地镜像',
  'Vm.assetCatalog.cloneTitle': '快速复制本地镜像',
  'Vm.assetCatalog.cloneNamePlaceholder': '请输入新的本地镜像名称',
  'Vm.assetCatalog.sourceAsset': '来源本地镜像',
...
const gatewayplugin = {
  ...
  'gatewayplugin.list.jwt-auth':'jwt-auth 插件支持使用 JSON Web Token（JWT）作为客户端访问上游资源前的认证机制。',
  'gatewayplugin.list.openid-connect':'openid-connect 插件支持接入 OpenID Connect 身份提供商，完成认证、令牌校验和用户信息透传。',
  'gatewayplugin.field_name': '字段名',
  'gatewayplugin.extra_config_label': '高级配置',
  'gatewayplugin.extra_config': '高级 JSON 配置会直接合并到插件配置中，适合填写当前表单未覆盖的 APISIX 插件字段。必须填写合法 JSON 对象，例如 {"cache_segment":"team-a"}。',
  'gatewayplugin.extra_config_input': '请输入合法 JSON 对象，例如 {"cache_segment":"team-a"}',
  'gatewayplugin.extra_config.invalid': '高级 JSON 配置格式错误，请检查后重试。',

  // limit-req
  'gatewayplugin.limit-req.null': '无',
  'gatewayplugin.limit-req.Notempty': '非空',
  'gatewayplugin.limit-req.rate_label': '请求速率',
  ...
  'gatewayplugin.limit-req.rejected_code_label': '拒绝状态码',
  ...
  'gatewayplugin.limit-req.allow_degradation_label': '允许降级放行',
  'gatewayplugin.limit-req.allow_degradation': '当设置为 true 时，如果限速插件功能临时不可用，将会自动允许请求继续。默认值为false',
  // limit-conn
  'gatewayplugin.limit-conn.conn_label': '最大并发数',
  ...
  'gatewayplugin.limit-conn.only_use_default_delay_label': '仅使用默认延迟',
  ...
  'gatewayplugin.limit-conn.rejected_code_label': '拒绝状态码',
  ...
  'gatewayplugin.limit-conn.rejected_msg_label': '拒绝响应内容',
  ...
  'gatewayplugin.limit-conn.allow_degradation_label': '允许降级放行',
  'gatewayplugin.limit-conn.allow_degradation': '当设置为 true 时，如果限速插件功能临时不可用，将会自动允许请求继续。默认值为false',
  // limit-count
  'gatewayplugin.limit-count.count_label': '请求次数上限',
  ...
  'gatewayplugin.limit-count.time_window_label': '时间窗口',
  ...
  'gatewayplugin.limit-count.rejected_code_label': '拒绝状态码',
  ...
  'gatewayplugin.limit-count.rejected_msg_label': '拒绝响应内容',
  'gatewayplugin.limit-count.rejected_msg': '当超过阈值的请求被拒绝时，返回的响应体。',
  'gatewayplugin.limit-count.policy_label': '计数策略',
  ...
  'gatewayplugin.limit-count.show_limit_quota_header_label': '显示限额响应头',
  ...
  'gatewayplugin.proxy-rewrite.headers.set_label': '设置请求头',
  ...
  'gatewayplugin.proxy-rewrite.headers.remove_label': '移除请求头',
  'gatewayplugin.proxy-rewrite.headers.remove': '移除请求头。格式为 ["name", ...]。',
  'gatewayplugin.proxy-rewrite.headers.remove_input': '请输入要移除的请求头',
  'gatewayplugin.proxy-rewrite.use_real_request_uri_unsafe_label': '使用原始请求 URI',
  ...
  // jwt-auth
  'gatewayplugin.jwt-auth.header_label': '请求头',
  'gatewayplugin.jwt-auth.header': '从指定请求头读取 JWT。默认值为 authorization。',
  'gatewayplugin.jwt-auth.header_input': '请输入请求头名称',
  'gatewayplugin.jwt-auth.query_label': '查询参数',
  'gatewayplugin.jwt-auth.query': '从指定 URL 查询参数读取 JWT。默认值为 jwt。',
  'gatewayplugin.jwt-auth.query_input': '请输入查询参数名称',
  'gatewayplugin.jwt-auth.cookie_label': 'Cookie 名称',
  'gatewayplugin.jwt-auth.cookie': '从指定 Cookie 读取 JWT。默认值为 jwt。',
  'gatewayplugin.jwt-auth.cookie_input': '请输入 Cookie 名称',
  'gatewayplugin.jwt-auth.hide_credentials_label': '隐藏凭据',
  'gatewayplugin.jwt-auth.hide_credentials': '启用后，转发到上游前会移除客户端请求中携带的 JWT 凭据。',
  'gatewayplugin.jwt-auth.claims_to_verify_label': '校验 Claims',
  'gatewayplugin.jwt-auth.claims_to_verify': '需要校验的 JWT claims，目前常用为 exp 和 nbf，用于校验过期时间和生效时间。',
  'gatewayplugin.jwt-auth.claims_to_verify_input': '请选择需要校验的 claims',
  'gatewayplugin.jwt-auth.anonymous_consumer_label': '匿名消费者',
  'gatewayplugin.jwt-auth.anonymous_consumer': 'JWT 缺失或校验失败时使用的匿名 Consumer 名称。留空时认证失败会直接拒绝请求。',
  'gatewayplugin.jwt-auth.anonymous_consumer_input': '请输入匿名 Consumer 名称',
  'gatewayplugin.jwt-auth.store_in_ctx_label': '存入上下文',
  'gatewayplugin.jwt-auth.store_in_ctx': '启用后，APISIX 会将认证结果存入上下文，便于后续插件读取。',
  'gatewayplugin.jwt-auth.realm_label': '认证域',
  'gatewayplugin.jwt-auth.realm': '认证失败时 WWW-Authenticate 响应头中的 realm 值。默认值为 jwt。',
  'gatewayplugin.jwt-auth.realm_input': '请输入 realm',
  'gatewayplugin.jwt-auth.key_claim_name_label': 'Key Claim',
  'gatewayplugin.jwt-auth.key_claim_name': '用于匹配 Consumer key 的 JWT claim 名称。默认值为 key。',
  'gatewayplugin.jwt-auth.key_claim_name_input': '请输入 claim 名称',
  // openid-connect
  'gatewayplugin.openid-connect.client_id_label': '客户端 ID',
  'gatewayplugin.openid-connect.client_id': 'OpenID Connect 客户端 ID，由身份提供商分配。',
  'gatewayplugin.openid-connect.client_id_input': '请输入 client_id',
  'gatewayplugin.openid-connect.client_secret_label': '客户端密钥',
  'gatewayplugin.openid-connect.client_secret': 'OpenID Connect 客户端密钥，由身份提供商分配。请避免在公开环境中泄露该值。',
  'gatewayplugin.openid-connect.client_secret_input': '请输入 client_secret',
  'gatewayplugin.openid-connect.discovery_label': '发现地址',
  'gatewayplugin.openid-connect.discovery': '身份提供商的 discovery 地址，通常以 /.well-known/openid-configuration 结尾。',
  'gatewayplugin.openid-connect.discovery_input': '请输入 discovery 地址',
  'gatewayplugin.openid-connect.scope_label': '授权范围',
  'gatewayplugin.openid-connect.scope': '请求的 OAuth/OIDC scope，多个 scope 用空格分隔。默认值为 openid。',
  'gatewayplugin.openid-connect.scope_input': '请输入 scope',
  'gatewayplugin.openid-connect.bearer_only_label': '仅 Bearer Token',
  'gatewayplugin.openid-connect.bearer_only': '启用后仅校验请求中的 Bearer Token，不会发起浏览器重定向登录流程。',
  'gatewayplugin.openid-connect.redirect_uri_label': '回调地址',
  'gatewayplugin.openid-connect.redirect_uri': '授权码流程的回调地址。需要和身份提供商客户端配置保持一致。',
  'gatewayplugin.openid-connect.redirect_uri_input': '请输入 redirect_uri',
  'gatewayplugin.openid-connect.realm_label': '认证域',
  'gatewayplugin.openid-connect.realm': '认证失败时 WWW-Authenticate 响应头中的 realm 值。默认值为 apisix。',
  'gatewayplugin.openid-connect.realm_input': '请输入 realm',
  'gatewayplugin.openid-connect.logout_path_label': '登出路径',
  'gatewayplugin.openid-connect.logout_path': '触发登出的路径。默认值为 /logout。',
  'gatewayplugin.openid-connect.logout_path_input': '请输入 logout_path',
  'gatewayplugin.openid-connect.post_logout_redirect_uri_label': '登出后跳转',
  'gatewayplugin.openid-connect.post_logout_redirect_uri': '登出完成后跳转的地址。',
  'gatewayplugin.openid-connect.post_logout_redirect_uri_input': '请输入登出后跳转地址',
  'gatewayplugin.openid-connect.ssl_verify_label': '校验证书',
  'gatewayplugin.openid-connect.ssl_verify': '是否校验身份提供商 HTTPS 证书。生产环境建议保持开启。',
  'gatewayplugin.openid-connect.timeout': '访问身份提供商接口的超时时间，单位为秒。',
  'gatewayplugin.openid-connect.timeout_input': '请输入超时时间',
  'gatewayplugin.openid-connect.introspection_endpoint_label': 'Token 校验端点',
  'gatewayplugin.openid-connect.introspection_endpoint': 'Token introspection 端点，用于向身份提供商校验 access token。',
  'gatewayplugin.openid-connect.introspection_endpoint_input': '请输入 introspection endpoint',
  'gatewayplugin.openid-connect.introspection_endpoint_auth_method_label': '校验端点认证方式',
  'gatewayplugin.openid-connect.introspection_endpoint_auth_method': '调用 introspection endpoint 时使用的客户端认证方式。',
  'gatewayplugin.openid-connect.introspection_endpoint_auth_method_input': '请选择认证方式',
  'gatewayplugin.openid-connect.token_endpoint_auth_method_label': 'Token 端点认证方式',
  'gatewayplugin.openid-connect.token_endpoint_auth_method': '调用 token endpoint 时使用的客户端认证方式。',
  'gatewayplugin.openid-connect.token_endpoint_auth_method_input': '请选择认证方式',
  'gatewayplugin.openid-connect.auth_method.client_secret_basic': 'client_secret_basic（Basic 认证）',
  'gatewayplugin.openid-connect.auth_method.client_secret_post': 'client_secret_post（表单提交密钥）',
  'gatewayplugin.openid-connect.auth_method.private_key_jwt': 'private_key_jwt（私钥 JWT）',
  'gatewayplugin.openid-connect.auth_method.client_secret_jwt': 'client_secret_jwt（密钥 JWT）',
  'gatewayplugin.openid-connect.public_key_label': '公钥',
  'gatewayplugin.openid-connect.public_key': '用于校验 JWT 签名的公钥。当不使用 JWKS 或 discovery 自动获取密钥时可填写。',
  'gatewayplugin.openid-connect.public_key_input': '请输入公钥内容',
  'gatewayplugin.openid-connect.use_jwks_label': '使用 JWKS',
  'gatewayplugin.openid-connect.use_jwks': '启用后从 JWKS 端点获取公钥校验 token。',
  'gatewayplugin.openid-connect.use_pkce_label': '使用 PKCE',
  'gatewayplugin.openid-connect.use_pkce': '启用授权码流程中的 PKCE 校验，需身份提供商客户端同步开启。',
  'gatewayplugin.openid-connect.token_signing_alg_values_expected_label': 'Token 签名算法',
  'gatewayplugin.openid-connect.token_signing_alg_values_expected': '期望的 token 签名算法，例如 RS256。留空时使用身份提供商返回的配置。',
  'gatewayplugin.openid-connect.token_signing_alg_values_expected_input': '请输入签名算法',
  'gatewayplugin.openid-connect.set_access_token_header_label': '透传 Access Token',
  'gatewayplugin.openid-connect.set_access_token_header': '启用后，将 access token 透传到上游请求头。',
  'gatewayplugin.openid-connect.access_token_in_authorization_header_label': '放入 Authorization',
  'gatewayplugin.openid-connect.access_token_in_authorization_header': '启用后，将 access token 放入 Authorization 请求头透传到上游。',
  'gatewayplugin.openid-connect.set_id_token_header_label': '透传 ID Token',
  'gatewayplugin.openid-connect.set_id_token_header': '启用后，将 ID token 透传到上游请求头。',
  'gatewayplugin.openid-connect.set_userinfo_header_label': '透传用户信息',
  'gatewayplugin.openid-connect.set_userinfo_header': '启用后，将用户信息透传到上游请求头。',
  'gatewayplugin.openid-connect.set_refresh_token_header_label': '透传 Refresh Token',
  'gatewayplugin.openid-connect.set_refresh_token_header': '启用后，将 refresh token 透传到上游请求头。仅在确有需要时开启。',
  'gatewayplugin.openid-connect.session.secret_label': '会话密钥',
  'gatewayplugin.openid-connect.session.secret': '用于加密浏览器会话 Cookie 的密钥。授权码流程或 standalone 模式通常需要显式配置。',
  'gatewayplugin.openid-connect.session.secret_input': '请输入 session secret',
  'gatewayplugin.openid-connect.unauth_action_label': '未认证处理',
  'gatewayplugin.openid-connect.unauth_action': '未认证请求的处理方式：auth 发起认证，deny 拒绝请求，pass 放行请求。',
  'gatewayplugin.openid-connect.unauth_action_input': '请选择未认证处理方式',
  // cors
  'gatewayplugin.cors.title': 'CORS 插件可以让你轻松启用跨域资源共享。',
  'gatewayplugin.cors.allow_origins_label': '允许来源',
  ...
  'gatewayplugin.cors.allow_methods_label': '允许方法',
  ...
  'gatewayplugin.cors.allow_headers_label': '允许请求头',
  ...
  'gatewayplugin.cors.expose_headers_label': '暴露响应头',
  ...
  'gatewayplugin.cors.allow_origins_by_metadata_label': '来源元数据引用',
  ...
  'gatewayplugin.real-ip.source_label': '真实 IP 来源',
  'gatewayplugin.real-ip.source': '从 APISIX 的视角动态设置客户端的 IP 地址和可选的端口,或客户端的主机名。',
  'gatewayplugin.real-ip.trusted_addresses_label': '可信地址',
  'gatewayplugin.real-ip.trusted_addresses': '动态设置 set_real_ip_from 字段。',
  'gatewayplugin.real-ip.recursive_label': '递归查找',
  ...
  'gatewayplugin.redirect.http_to_https_label': 'HTTP 转 HTTPS',
  ...
  'gatewayplugin.redirect.uri_label': '重定向 URI',
  ...
  'gatewayplugin.redirect.regex_uri_label': '正则重定向 URI',
  ...
  'gatewayplugin.redirect.ret_code_label': '重定向状态码',
  'gatewayplugin.redirect.ret_code': 'HTTP 响应状态码。',
  'gatewayplugin.redirect.encode_uri_label': '编码 URI',
  'gatewayplugin.redirect.encode_uri': '设置为 true 时,Location 头中的 URI 将按照 RFC3986 进行编码。',
  'gatewayplugin.redirect.append_query_string_label': '附加查询参数',
  ...
  'gatewayplugin.client_control.max_body_size_label': '最大请求体大小',
