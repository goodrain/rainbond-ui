...
const componentOverview = {
    ...
    'componentOverview.agent_abnormal_guide.title': '组件运行异常',
    'componentOverview.agent_abnormal_guide.description': '组件“{component}”当前运行异常，可能影响服务可用性。AI 助手会结合组件状态与运行上下文协助定位问题。',
    'componentOverview.agent_abnormal_guide.capability_lead': 'AI 可协助',
    'componentOverview.agent_abnormal_guide.capability_cause': '原因分析',
    'componentOverview.agent_abnormal_guide.capability_steps': '排查步骤',
    'componentOverview.agent_abnormal_guide.capability_advice': '处理建议',
    'componentOverview.agent_abnormal_guide.action': '使用 AI 助手排查',
    'componentOverview.agent_abnormal_guide.suppress': '本次会话不再弹出',
    'componentOverview.agent_abnormal_guide.draft': '组件“{component}”当前状态异常，请结合当前组件上下文帮我分析原因并给出排查步骤。',
    // MoveGroup
    ...
    'componentOverview.body.tab.overview.vmProfile': '虚拟机概览',
    'componentOverview.body.tab.overview.vmAssetInfo': '本地镜像信息',
    'componentOverview.body.tab.overview.vmAssetName': '本地镜像名称',
    'componentOverview.body.tab.overview.vmAssetSource': '来源类型',
    'componentOverview.body.tab.overview.vmAssetArchFormat': '架构 / 格式',
    'componentOverview.body.tab.overview.vmAssetParent': '来源本地镜像',
    'componentOverview.body.tab.overview.vmAssetReferences': '引用数量',
    'componentOverview.body.tab.overview.vmNetworkInfo': '网络信息',
    'componentOverview.body.tab.overview.vmClusterIP': '访问 IP',
    'componentOverview.body.tab.overview.vmPodIP': 'Pod IP',
    'componentOverview.body.tab.overview.vmFixedIP': '固定 IP',
    'componentOverview.body.tab.overview.vmFixedIPSwitch': '固定当前 IP',
    'componentOverview.body.tab.overview.vmFixedIPNoPodIP': '当前 Pod IP 尚未准备完成，请启动虚拟机后再固定。',
    'componentOverview.body.tab.overview.vmFixedIPEnableTitle': '确认固定当前 IP？',
    'componentOverview.body.tab.overview.vmFixedIPEnableContent': '将以当前 Pod IP {ip} 作为固定 IP，并立即重启虚拟机生效。',
    'componentOverview.body.tab.overview.vmFixedIPEnableConfirm': '固定并重启',
    'componentOverview.body.tab.overview.vmFixedIPEnableSuccess': '固定 IP 已提交，虚拟机将重启生效',
    'componentOverview.body.tab.overview.vmFixedIPDisableTitle': '确认取消固定 IP？',
    'componentOverview.body.tab.overview.vmFixedIPDisableContent': '取消后虚拟机 Pod IP 可随重启变化，并会立即重启生效。',
    'componentOverview.body.tab.overview.vmFixedIPDisableConfirm': '取消固定并重启',
    'componentOverview.body.tab.overview.vmFixedIPDisableSuccess': '固定 IP 已取消，虚拟机将重启生效',
    'componentOverview.body.tab.overview.vmNetworkTip': 'Pod IP 会在重启后变化，如需固定访问入口请添加端口',
    'componentOverview.body.tab.overview.vmFixedIPNetworkTip': '固定 IP 已开启，Pod IP 将在重启后保持当前值；修改规格需要重启生效。',
    'componentOverview.body.tab.overview.vmAccelerationInfo': 'GPU 直通与 USB 透传',
    'componentOverview.body.tab.overview.vmGpu': 'GPU 直通',
    'componentOverview.body.tab.overview.vmUsb': 'USB 透传',
    'componentOverview.body.tab.overview.vmConnectionInfo': '连接信息',
    'componentOverview.body.tab.overview.vmOpenVnc': '打开Web VNC',
    'componentOverview.body.tab.overview.vmConnectionPending': '连接信息准备中',
    'componentOverview.body.tab.overview.vmDisabled': '未开启',
    'componentOverview.body.tab.overview.vmEnabled': '已开启',
    ...
    'componentOverview.body.tab.overview.vmHotUpdateUnsupported': '当前虚拟机不满足热更新条件，本次调整将自动重启生效。',
    'componentOverview.body.tab.overview.vmHotUpdateStoppedTip': '当前虚拟机处于停机状态，规格修改将在下次启动后生效。',
    'componentOverview.body.tab.overview.vmHotUpdateRestartFallbackTip': '当前虚拟机不满足热更新条件，保存后将自动调整规格并重启生效',
    ...
    'componentOverview.body.tab.overview.vmHotUpdateRestartConfirm': '修改并重启',
    'componentOverview.body.tab.overview.vmFixedIPScalingTip': '固定当前 IP 已开启：不支持热迁移，CPU / 内存热更新不可用。修改规格后需要重启虚拟机生效。',
    ...
    'componentOverview.body.tab.overview.vmHotUpdateCombinedBlocked': '运行中虚拟机 CPU 和内存热更新请分两次操作，不支持一次同时修改。',
    'componentOverview.body.tab.overview.vmHotUpdateMemoryLockedByCpuChange': '已修改 CPU，本次保存前不能同时修改内存；请先保存 CPU 热更新后再调整内存。',
    'componentOverview.body.tab.overview.vmHotUpdateCpuLockedByMemoryChange': '已修改内存，本次保存前不能同时修改 CPU；请先保存内存热更新后再调整 CPU。',
    'componentOverview.body.tab.overview.vmGpuPassthroughScalingLocked': '已绑定 GPU 直通的虚拟机不支持扩缩容。',
    'componentOverview.body.tab.overview.vmUsbPassthroughScalingLocked': '已绑定 USB 透传的虚拟机不支持扩缩容。',
    ...
    'componentOverview.body.tab.env.setting.volume_type': '类型',
    'componentOverview.body.tab.env.setting.volume_status': '状态',
    ...
    'componentOverview.body.tab.AddStorage.name': '配置项名称',
    'componentOverview.body.tab.AddStorage.input': '请输入配置项名称',
    'componentOverview.body.tab.AddStorage.max': '最大长度30位',
    'componentOverview.body.tab.AddStorage.path': '容器内文件路径',
    'componentOverview.body.tab.AddStorage.input_path': '例如：/app/app.conf',
    'componentOverview.body.tab.AddStorage.full_file_path': '请输入完整文件路径，例如 /app/app.conf',
    ...
    'componentOverview.body.Expansion.daemonsetScalingTip': '守护进程类型组件会在每个符合调度条件的节点上运行一个实例，实例数量由节点调度决定，因此实例数量调整和自动伸缩配置不可操作。',
    ...
    'componentOverview.body.mnt.expansion_confirm_title': '确认扩容存储',
    ...
    'componentOverview.body.mnt.expansion_status.unsupported': '不可扩容',
    ...
    'componentOverview.body.mnt.status.restoring': '虚拟机磁盘恢复中，无法操作文件管理',
    ...
    'componentOverview.body.AddVolumes.integer': '存储容量必须为整数',
    'componentOverview.body.AddVolumes.shrink_unsupported': '存储容量只能扩容，不能小于当前请求或实际容量 {capacity}GB',
    'componentOverview.body.AddVolumes.actual_capacity': 'PVC 实际容量：{capacity}GB',
    'componentOverview.body.AddVolumes.expansion_unavailable': '该存储当前不支持在线扩容',
    ...
    'componentOverview.body.handleEdit.share': '配置文件和持久化存储',
    'componentOverview.body.handleEdit.config_file': '配置文件',
    'componentOverview.body.handleEdit.persistent_storage': '持久化存储',
    ...
    'componentOverview.body.handleEdit.shared_storage': '持久化存储',
    'componentOverview.body.handleEdit.storage_class': '存储类型',
    'componentOverview.body.handleEdit.capacity': '容量(Gi)',
    'componentOverview.body.handleEdit.access_mode': '访问模式',
    ...
    'componentOverview.body.StorageConfig.Maximum_limit': '容量最大值为500Gi',
    'componentOverview.body.StorageConfig.Limit': '容量最小值为1Gi',
    'componentOverview.body.StorageConfig.edit': '编辑存储',
    'componentOverview.body.StorageConfig.add': '添加存储',
    'componentOverview.body.StorageConfig.add_config_file': '新增配置文件',
    'componentOverview.body.StorageConfig.edit_config_file': '编辑配置文件',
    'componentOverview.body.StorageConfig.add_persistent_storage': '新增持久化存储',
    'componentOverview.body.StorageConfig.edit_persistent_storage': '编辑持久化存储',
    'componentOverview.body.StorageConfig.name': '名称',
    'componentOverview.body.StorageConfig.input_name': '请输入名称',
    'componentOverview.body.StorageConfig.Maximum_length': '最大长度23位',
    'componentOverview.body.StorageConfig.only': '只支持小写字母、数字和连字符，并且必须以字母或数字开始和结束',
    'componentOverview.body.StorageConfig.duplicate_name': '名称已存在',
    'componentOverview.body.StorageConfig.duplicate_path': '挂载路径已存在',
    ...
    'componentOverview.body.StorageConfig.shared_storage': '持久化存储',
    'componentOverview.body.StorageConfig.capacity_range': '容量范围：{min}–{max} Gi',
    ...
    'componentOverview.body.GoCNBConfig.version': 'Go 版本',
    'componentOverview.body.GoCNBConfig.version_tip': '选择构建和运行时使用的 Go 主次版本',
    'componentOverview.body.GoCNBConfig.goproxy': '镜像源',
    'componentOverview.body.GoCNBConfig.goproxy_tip': '指定 Go module 下载镜像源，默认使用 https://goproxy.cn',
    'componentOverview.body.GoCNBConfig.goprivate': '私有模块前缀',
    'componentOverview.body.GoCNBConfig.goprivate_tip': '指定私有模块前缀，避免走公共代理与校验',
    'componentOverview.body.GoCNBConfig.targets': '构建目标',
    'componentOverview.body.GoCNBConfig.targets_tip': '指定要编译的 main 包；支持冒号分隔多个 target，例如 ./cmd/api:./cmd/worker',
    'componentOverview.body.GoCNBConfig.build_flags': '构建参数',
    'componentOverview.body.GoCNBConfig.build_flags_tip': '追加或覆盖 go build 的构建参数',
    'componentOverview.body.GoCNBConfig.ldflags': '链接参数',
    'componentOverview.body.GoCNBConfig.ldflags_tip': '设置 go build -ldflags，常用于注入版本信息或裁剪二进制体积',
    'componentOverview.body.GoCNBConfig.start_mode': '启动方式',
    'componentOverview.body.GoCNBConfig.start_mode_tip': '单模块 Go 应用通常使用默认启动进程；需要覆盖启动参数时再切到自定义',
    'componentOverview.body.GoCNBConfig.start_mode_default': '默认',
    'componentOverview.body.GoCNBConfig.start_mode_custom': '自定义',
    'componentOverview.body.GoCNBConfig.start_command': '启动命令',
    'componentOverview.body.GoCNBConfig.start_command_tip': '仅在需要覆盖 Paketo 默认启动进程时填写',
    'componentOverview.body.GoCNBConfig.start_command_placeholder': '例如：web: ./api --port $PORT',
    'componentOverview.body.DotNetCNBConfig.version': '运行时版本',
    'componentOverview.body.DotNetCNBConfig.version_tip': '选择 .NET / ASP.NET Core 运行时版本，默认使用平台版本策略的默认值',
    'componentOverview.body.DotNetCNBConfig.project_path': '项目路径',
    'componentOverview.body.DotNetCNBConfig.project_path_tip': '多项目 solution 场景指定启动项目路径，例如 ./src/WebApp',
    'componentOverview.body.DotNetCNBConfig.publish_flags': '发布参数',
    'componentOverview.body.DotNetCNBConfig.publish_flags_tip': '追加或覆盖 dotnet publish 参数，例如 --verbosity=normal --self-contained=true',
    'componentOverview.body.DotNetCNBConfig.nuget_config': 'NuGet 配置',
    'componentOverview.body.DotNetCNBConfig.nuget_config_tip': '选择或填写 NuGet 配置名称，最终映射为 nugetconfig binding',
    'componentOverview.body.DotNetCNBConfig.start_mode': '启动方式',
    'componentOverview.body.DotNetCNBConfig.start_mode_tip': '默认使用 Paketo 生成的启动进程，如需覆盖请切换为自定义',
    'componentOverview.body.DotNetCNBConfig.start_mode_default': '默认',
    'componentOverview.body.DotNetCNBConfig.start_mode_custom': '自定义',
    'componentOverview.body.DotNetCNBConfig.start_command': '启动命令',
    'componentOverview.body.DotNetCNBConfig.start_command_tip': '仅在自定义时填写，将写入 Procfile 覆盖默认启动进程',
    ...
    'componentOverview.body.NodeJSCNB.framework': '项目框架',
    'componentOverview.body.NodeJSCNB.framework_tip_static': '纯静态项目，选择静态站点框架',
    'componentOverview.body.NodeJSCNB.framework_tip': '选择您的项目使用的框架，前端框架将构建为静态站点，后端框架将作为 Node.js 服务运行',
    'componentOverview.body.NodeJSCNB.framework_placeholder': '请选择框架',
    'componentOverview.body.NodeJSCNB.framework_group_static_only': '纯静态站点',
    'componentOverview.body.NodeJSCNB.framework_group_static': '前端框架（静态站点）',
    'componentOverview.body.NodeJSCNB.framework_group_server': '后端框架（Node.js 服务）',
    'componentOverview.body.NodeJSCNB.node_version': 'Node 版本',
    'componentOverview.body.NodeJSCNB.node_version_tip': '选择 Node.js 运行时版本',
    'componentOverview.body.NodeJSCNB.node_env_tip': '构建阶段的 NODE_ENV 环境变量，production 模式下构建产物更小、性能更优',
    'componentOverview.body.NodeJSCNB.mirror_config': 'Mirror 配置',
    'componentOverview.body.NodeJSCNB.mirror_config_tip': '配置 npm/yarn/pnpm 的镜像源。可以使用项目中的配置文件，或自定义配置内容',
    'componentOverview.body.NodeJSCNB.mirror_project': '使用项目配置',
    'componentOverview.body.NodeJSCNB.mirror_custom': '使用自定义配置',
    'componentOverview.body.NodeJSCNB.custom_config': '自定义配置',
    'componentOverview.body.NodeJSCNB.custom_config_tip': '为当前组件配置镜像源，构建时将自动注入到容器中',
    'componentOverview.body.NodeJSCNB.edit': '编辑',
    'componentOverview.body.NodeJSCNB.configured': '已配置',
    'componentOverview.body.NodeJSCNB.edit_config': '编辑 {type} 配置',
    'componentOverview.body.NodeJSCNB.save': '保存',
    'componentOverview.body.NodeJSCNB.cancel': '取消',
    'componentOverview.body.NodeJSCNB.fill_default': '填写默认配置',
    'componentOverview.body.NodeJSCNB.config_placeholder': '请输入 {type} 配置内容，例如：\nregistry=https://registry.npmmirror.com',
    'componentOverview.body.NodeJSCNB.output_dir': '输出目录',
    'componentOverview.body.NodeJSCNB.output_dir_tip_static': '静态文件所在目录，默认为根目录 .',
    'componentOverview.body.NodeJSCNB.output_dir_tip': '构建产物目录，如 dist、build、out',
    'componentOverview.body.NodeJSCNB.build_cmd': '构建命令',
    'componentOverview.body.NodeJSCNB.build_cmd_tip': '只填写 package.json 中的 scripts 名称，如 build、build:prod，不要填写 npm run build、pnpm run build 或 yarn build',
    'componentOverview.body.NodeJSCNB.start_cmd': '启动命令',
    'componentOverview.body.NodeJSCNB.start_cmd_tip': '只填写 package.json 中的 scripts 名称，如 start、start:prod，不要填写 npm run start、pnpm run start 或 yarn start',
    'componentOverview.body.NodeJSCNB.start_cmd_placeholder': '留空自动检测',
    'componentOverview.body.NodeJSCNB.script_name_error': '请只填写 package.json 中的 scripts 名称，不要包含 npm、pnpm 或 yarn',
    ...
    'componentOverview.body.JavaMavenConfig.configuration': 'Maven Java参数',
    ...
    'componentOverview.body.JavaCNBConfig.disable_cache_tip': '控制本次构建是否禁用缓存',
    'componentOverview.body.JavaCNBConfig.jvm_version_tip': '选择构建和运行时使用的 Java 主版本',
    'componentOverview.body.JavaCNBConfig.jvm_type': 'JVM 类型',
    'componentOverview.body.JavaCNBConfig.jvm_type_tip': '默认使用 JRE. 仅在运行期依赖 JDK 工具时选择 JDK',
    'componentOverview.body.JavaCNBConfig.maven_settings_tip': 'Maven Setting.xml 配置',
    'componentOverview.body.JavaCNBConfig.maven_build_cmd_tip': 'Maven 构建主命令',
    'componentOverview.body.JavaCNBConfig.maven_extra_args_tip': '追加到主构建命令后的 Maven 参数',
    'componentOverview.body.JavaCNBConfig.maven_java_opts_tip': 'Maven 进程自身的 JVM 参数',
    'componentOverview.body.JavaCNBConfig.mvn_module': '构建模块',
    'componentOverview.body.JavaCNBConfig.maven_module_tip': '填写最终运行模块相对于源码根目录的路径。填写后，平台会在该模块内自动查找构建产物',
    'componentOverview.body.JavaCNBConfig.mvn_artifact': '目标产物',
    'componentOverview.body.JavaCNBConfig.maven_artifact_tip': '填写构建产物相对于源码根目录的完整路径。填写后无需填写构建模块',
    'componentOverview.body.JavaCNBConfig.gradle_build_cmd': '构建命令',
    'componentOverview.body.JavaCNBConfig.gradle_build_cmd_tip': 'Gradle 主构建命令',
    'componentOverview.body.JavaCNBConfig.gradle_extra_args': 'Gradle 附加参数',
    'componentOverview.body.JavaCNBConfig.gradle_extra_args_tip': '追加到主构建命令后的参数',
    'componentOverview.body.JavaCNBConfig.gradle_module': '构建模块',
    'componentOverview.body.JavaCNBConfig.gradle_module_tip': '填写最终运行模块相对于源码根目录的路径。填写后，平台会在该模块内自动查找构建产物',
    'componentOverview.body.JavaCNBConfig.gradle_artifact': '目标产物',
    'componentOverview.body.JavaCNBConfig.gradle_artifact_tip': '填写构建产物相对于源码根目录的完整路径。填写后无需填写构建模块',
    'componentOverview.body.JavaCNBConfig.module_disabled_tip': '已填写目标产物，无需再填写构建模块。如需自动查找模块产物，请先清空目标产物。',
    'componentOverview.body.JavaCNBConfig.artifact_disabled_tip': '已填写构建模块，平台将自动查找模块内产物。如需指定产物，请先清空构建模块。',
    'componentOverview.body.JavaCNBConfig.artifact_conflict_tip': '当前同时配置了构建模块和目标产物，平台将优先使用目标产物。建议保留一种配置。',
    'componentOverview.body.JavaCNBConfig.module_disabled_placeholder': '请先清空目标产物',
    'componentOverview.body.JavaCNBConfig.artifact_disabled_placeholder': '请先清空构建模块',
    'componentOverview.body.JavaCNBConfig.executable_jar': '可执行 JAR 路径',
    'componentOverview.body.JavaCNBConfig.executable_jar_tip': '仓库中存在多个 JAR 时，显式指定作为入口的可执行 JAR',
    'componentOverview.body.JavaCNBConfig.start_mode': '启动方式',
    'componentOverview.body.JavaCNBConfig.start_mode_default': '默认',
    'componentOverview.body.JavaCNBConfig.start_mode_custom': '自定义',
    'componentOverview.body.JavaCNBConfig.start_command': '启动命令',
    'componentOverview.body.JavaCNBConfig.start_command_tip': '留空则使用默认启动进程',
    'componentOverview.body.JavaCNBConfig.start_command_placeholder': '留空时使用 Paketo 默认启动进程',
    'componentOverview.body.JavaCNBConfig.source_default': '默认',
    'componentOverview.body.JavaCNBConfig.source_procfile': 'Procfile',
    'componentOverview.body.JavaCNBConfig.source_user': '用户覆盖',
    ...
    'componentOverview.body.PHPCNBConfig.version': 'PHP版本',
    'componentOverview.body.PHPCNBConfig.version_tip': '选择构建和运行时使用的 PHP 主次版本，默认使用平台版本策略的默认值',
    'componentOverview.body.PHPCNBConfig.composer_install_options': 'Composer 安装参数',
    'componentOverview.body.PHPCNBConfig.composer_install_options_tip': '追加或覆盖 composer install 参数，例如 --no-dev --optimize-autoloader',
    'componentOverview.body.PHPCNBConfig.web_dir': 'Web 根目录',
    'componentOverview.body.PHPCNBConfig.web_dir_tip': '指定 PHP Web 根目录，例如 public',
    'componentOverview.body.PHPCNBConfig.start_mode': '启动方式',
    'componentOverview.body.PHPCNBConfig.start_mode_tip': '默认使用 Paketo 生成的启动进程，如需覆盖请切换为自定义',
    'componentOverview.body.PHPCNBConfig.start_mode_default': '默认',
    'componentOverview.body.PHPCNBConfig.start_mode_custom': '自定义',
    'componentOverview.body.PHPCNBConfig.start_command': '启动命令',
    'componentOverview.body.PHPCNBConfig.start_command_tip': '仅在自定义时填写，将写入 Procfile 覆盖默认启动进程',
    ...
    'componentOverview.body.PythonCNBConfig.trusted_host_tip': '指定 pip / pipenv 可信主机',
    'componentOverview.body.PythonCNBConfig.poetry_source_name': 'Poetry 源名称',
    'componentOverview.body.PythonCNBConfig.poetry_source_name_tip': '指定 Poetry 私服源名称',
    'componentOverview.body.PythonCNBConfig.poetry_source_url': 'Poetry 源地址',
    'componentOverview.body.PythonCNBConfig.poetry_source_url_tip': '指定 Poetry 私服源地址',
    'componentOverview.body.PythonCNBConfig.conda_channel_url': 'Conda Channel 地址',
    'componentOverview.body.PythonCNBConfig.conda_channel_url_tip': '指定 conda 私有 channel 地址',
    'componentOverview.body.PythonCNBConfig.start_command': '启动命令',
    'componentOverview.body.PythonCNBConfig.start_command_tip': '平台优先自动识别启动命令；识别失败时再手工配置',
    'componentOverview.body.PythonCNBConfig.start_command_placeholder': '平台将优先自动识别启动命令',
    'componentOverview.body.PythonCNBConfig.source_auto': '自动识别',
    'componentOverview.body.PythonCNBConfig.source_procfile': 'Procfile',
    'componentOverview.body.PythonCNBConfig.source_user': '用户覆盖',
    ...
    'componentOverview.body.Kubernetes.input_cmd': '请按 YAML 字符串数组填写 cmd 属性',
    ...
    'componentOverview.body.Kubernetes.yaml': '该配置以 YAML 格式存储，请点击右侧编辑按钮查看或修改。',
    'componentOverview.body.Kubernetes.cmd_args_yaml_tip': 'cmd 和 args 请按 YAML 字符串数组填写，每个列表项会作为一个完整参数，不会按空格拆分。',
    'componentOverview.body.Kubernetes.cmd_args_yaml_array': 'cmd 和 args 必须是 YAML 数组，例如：- /bin/sh',
    'componentOverview.body.Kubernetes.cmd_args_yaml_string_array': 'cmd 和 args 的每个 YAML 数组项都必须是字符串',
    ...
    'kubeblocks.database.config.btn.prev': '放弃',
    'kubeblocks.database.config.btn.create': '确认创建',
    ...
    'kubeblocks.parameter.unsupported': '当前数据库不支持参数配置',
    'kubeblocks.parameter.empty': '暂无参数数据',
    'kubeblocks.database.config.storage_placeholder': '请输入磁盘大小',
    'kubeblocks.database.config.replicas_label': '实例数',
    'kubeblocks.database.config.replicas_required': '请配置实例数',
    'kubeblocks.database.config.replicas_placeholder': '请输入实例数',
    'kubeblocks.database.config.storageClass_label': '存储类',
    'kubeblocks.database.config.storageClass_required': '请选择存储类',
    'kubeblocks.database.config.storageClass_placeholder': '请选择存储类',
    'kubeblocks.database.config.version_label': '版本',
    'kubeblocks.database.config.version_required': '请选择数据库版本',
    'kubeblocks.database.backup.title': '备份策略',
    'kubeblocks.database.backup.repo_label': '备份仓库',
    'kubeblocks.database.backup.repo_placeholder': '请选择备份仓库',
    ...
    'kubeblocks.database.backup.repo.phase.available': '可用',
    'kubeblocks.database.backup.repo.phase.checking': '检测中',
    'kubeblocks.database.backup.repo.phase.failed': '检测失败',
    'kubeblocks.database.backup.repo.phase.deleting': '删除中',
    'kubeblocks.database.backup.repo.phase.unavailable': '不可用',
    'kubeblocks.database.backup.repo.advanced': '高级配置',
    'kubeblocks.database.backup.repo.path_prefix': '路径前缀',
    'kubeblocks.database.backup.repo.access_style': '对象存储访问方式',
    'kubeblocks.database.backup.repo.access_style_path': '路径风格（MinIO / 自建 S3 推荐）',
    'kubeblocks.database.backup.repo.access_style_virtual': '虚拟主机风格（阿里云 OSS / AWS S3 推荐）',
    'kubeblocks.database.backup.repo.access_style_path_short': '路径风格',
    'kubeblocks.database.backup.repo.access_style_virtual_short': '虚拟主机风格',
    'kubeblocks.database.backup.repo.access_style_hint': '不同对象存储服务对 Bucket 的访问方式要求不同。MinIO 通常选择路径风格，阿里云 OSS 通常选择虚拟主机风格。',
    'kubeblocks.database.backup.repo.name_required': '请输入仓库名称',
    'kubeblocks.database.backup.repo.name_invalid': '只能包含小写字母、数字和中划线',
    'kubeblocks.database.backup.repo.bucket_required': '请输入 Bucket',
    'kubeblocks.database.backup.repo.endpoint_required': '请输入 Endpoint',
    'kubeblocks.database.backup.repo.access_key_required': '请输入 AccessKey',
    'kubeblocks.database.backup.repo.secret_key_required': '请输入 SecretKey',
    'kubeblocks.database.backup.repo.secret_keep': '留空则保持不变',
    'kubeblocks.database.backup.repo.credential_edit_hint': 'AccessKey 和 SecretKey 不会回显；留空则保持原凭据，如需修改请同时填写。',
    'kubeblocks.database.backup.repo.delete_confirm': '确定删除该备份仓库吗？被数据库引用时将无法删除。',
    'kubeblocks.database.backup.repo.create_success': '备份仓库创建成功',
    'kubeblocks.database.backup.repo.create_failed': '备份仓库创建失败',
    'kubeblocks.database.backup.repo.update_success': '备份仓库更新成功',
    'kubeblocks.database.backup.repo.update_failed': '备份仓库更新失败',
    'kubeblocks.database.backup.repo.delete_success': '备份仓库删除成功',
    'kubeblocks.database.backup.repo.delete_failed': '备份仓库删除失败',
    'kubeblocks.database.backup.repo.checking': '备份仓库已提交，正在检测对象存储连接...',
    'kubeblocks.database.backup.repo.check_success': '备份仓库检测通过',
    'kubeblocks.database.backup.repo.check_failed': '备份仓库检测失败',
    'kubeblocks.database.backup.repo.check_timeout': '备份仓库仍在检测中，可稍后刷新查看状态',
    'kubeblocks.database.backup.repo_not_ready': '备份仓库检测未通过，不能使用',
    ...
    'kubeblocks.database.backup.startTime_label': '开始时间',
    'kubeblocks.database.backup.startTime_required': '请配置备份开始时间',
    ...
    'kubeblocks.database.backup.retention_label': '保留时间',
    'kubeblocks.database.backup.retention_required': '请配置备份保留时间',
    ...
    'kubeblocks.database.backup.page.title': '备份策略',
    'kubeblocks.database.backup.page.list.title': '备份列表',
    'kubeblocks.database.backup.unsupported.alert': '当前数据库类型不支持备份',
...
const componentOther = {
    ...
    // ThirdList 组件 - Git仓库认证
    'componentOverview.body.ThirdList.auth_expired_title': '您的 {name} 仓库认证已过期',
    'componentOverview.body.ThirdList.auth_required_title': '您还未认证 {name} 仓库',
    'componentOverview.body.ThirdList.auth_expired_desc': '认证已过期，请重新认证后才能访问该仓库的项目列表。',
    'componentOverview.body.ThirdList.auth_required_desc': '请先完成认证后才能访问该仓库的项目列表。',
    'componentOverview.body.ThirdList.go_auth': '去认证',
    'componentOverview.body.ThirdList.create_component': '创建组件',
    'componentOverview.body.ThirdList.search_placeholder': '请输入搜索内容',
    'componentOverview.body.ThirdList.component_name': '组件名称',
    'componentOverview.body.ThirdList.language': '语言',
    'componentOverview.body.ThirdList.detect_language': '检测语言',
    'componentOverview.body.ThirdList.close': '关闭',
    'componentOverview.body.ThirdList.detect': '检测',
    'componentOverview.body.ThirdList.confirm': '确认',
    'componentOverview.body.ThirdList.detecting': '检测中，请稍后(请勿关闭弹窗)',
    'componentOverview.body.ThirdList.multi_module': '{language} 多模块',
    'componentOverview.body.ThirdList.detect_failed': '检测失败，请重新检测',
    'componentOverview.body.ThirdList.confirm_detect': '确定要检测语言吗?',
    'componentOverview.body.ThirdList.loading_more': '加载更多...',
    'componentOverview.body.ThirdList.all_loaded': '已加载全部仓库',
    'componentOverview.body.ThirdList.back_to_list': '回到列表',
    'componentOverview.body.ThirdList.search_button': '搜索',

    // CreateComponentModal 组件
    'componentOverview.body.CreateComponentModal.from_market': '从应用市场安装',
    'componentOverview.body.CreateComponentModal.from_image': '从镜像构建',
    'componentOverview.body.CreateComponentModal.from_source': '从源码构建',
    'componentOverview.body.CreateComponentModal.database': '数据库',
    'componentOverview.body.CreateComponentModal.local_market': '本地组件库',
    'componentOverview.body.CreateComponentModal.offline_import': '上传应用模板',
    'componentOverview.body.CreateComponentModal.image_entry': '从镜像构建',
    'componentOverview.body.CreateComponentModal.source_entry': '从源码构建',
    ...
    'componentOverview.body.CreateComponentModal.yaml_entry': 'Yaml 部署',
    'componentOverview.body.CreateComponentModal.helm': 'Helm',
    'componentOverview.body.CreateComponentModal.helm_entry': 'Helm 部署',
    'componentOverview.body.CreateComponentModal.third_party': '第三方组件',
    'componentOverview.body.CreateComponentModal.rainbond_app_model': 'Rainbond应用模型',
    'componentOverview.body.CreateComponentModal.k8s_native_resource': 'K8s原生资源直连',
    'componentOverview.body.CreateComponentModal.market_store': '应用商店',
    'componentOverview.body.CreateComponentModal.install_app': '安装 {name}',
    'componentOverview.body.CreateComponentModal.install': '安装应用',
    'componentOverview.body.CreateComponentModal.private_image_repo': '私有镜像仓库',
    'componentOverview.body.CreateComponentModal.plugin': '插件',
    'componentOverview.body.CreateComponentModal.repo': '{name} 仓库',
    'componentOverview.body.CreateComponentModal.source_repo': '源码仓库',
    'componentOverview.body.CreateComponentModal.create_component': '创建组件',
    'componentOverview.body.CreateComponentModal.add_private_image': '添加私有镜像仓库',
    'componentOverview.body.CreateComponentModal.add_private_image_desc': '配置您的私有镜像仓库地址',
    'componentOverview.body.CreateComponentModal.add_source_repo': '添加源码仓库',
    'componentOverview.body.CreateComponentModal.add_source_repo_desc': '配置您的私有源码仓库地址',
    'componentOverview.body.CreateComponentModal.confirm_create': '确认创建',
    'componentOverview.body.CreateComponentModal.estimate_daily': '预估(每天)',
    ...
    'componentOverview.body.CreateComponentModal.group_market': '应用市场',
    'componentOverview.body.CreateComponentModal.group_custom_build': '自定义构建',
    ...
    'componentOverview.body.CreateComponentModal.database_install_required': '请先安装数据库插件',
    'componentOverview.body.CreateComponentModal.database_install_confirm_desc': '当前平台未安装数据库插件，是否前往功能扩展页面安装？',
    'componentOverview.body.CreateComponentModal.database_contact_admin_title': '未安装数据库插件',
    'componentOverview.body.CreateComponentModal.database_contact_admin_desc': '当前平台未安装数据库插件，请联系企业管理员前往功能扩展页面安装。',
    'componentOverview.body.CreateComponentModal.vm': '虚拟机 (VM)',
    'componentOverview.body.CreateComponentModal.vm_install_required': '请先安装虚拟机插件',
    'componentOverview.body.CreateComponentModal.vm_install_confirm_desc': '当前平台未安装虚拟机插件，是否前往功能扩展页面安装？',
    'componentOverview.body.CreateComponentModal.vm_contact_admin_title': '未安装虚拟机插件',
    'componentOverview.body.CreateComponentModal.vm_contact_admin_desc': '当前平台未安装虚拟机插件，请联系企业管理员前往功能扩展页面安装。',
    ...
    'composeCheckInfo.config_files': '配置文件',
    'composeCheckInfo.uploaded': '已上传',
    'composeCheckInfo.all_uploaded': '全部已上传',
    'composeCheckInfo.status_uploaded': '已上传',
    'composeCheckInfo.status_pending': '待上传',
    'composeCheckInfo.reupload': '重新上传',
    'composeCheckInfo.conversion_notes': '功能限制',
    'composeCheckInfo.not_supported': '不支持',
    'composeCheckInfo.need_attention': '需留意',
    'composeCheckInfo.solve_advice': '建议',
    'composeCheckInfo.upload_config_file': '上传配置文件',
    'composeCheckInfo.upload_hint': '点击或拖拽文件到此区域上传',
    'composeCheckInfo.upload_hint_desc': '支持单个文件上传，文件需为 UTF-8 编码',
    'composeCheckInfo.upload_success': '上传成功',
    'composeCheckInfo.upload_failed': '上传失败',
    'composeCheckInfo.build_disabled_tip': '请先上传全部配置文件（还有 {count} 个待上传）',
}
