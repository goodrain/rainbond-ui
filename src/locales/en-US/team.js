...
const Vm = {
  ...
  'Vm.createVm.selectLiveMigrationStorage': 'Please select a live-migration-capable storage type',
  'Vm.createVm.noLiveMigrationStorage': 'No shared storage type is available for VM live migration in the current team',
  'Vm.createVm.noLiveMigrationStorageHint': 'Only storage types whose access modes include RWX are shown here.',
