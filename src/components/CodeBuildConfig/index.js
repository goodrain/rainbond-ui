    ...
    return (
      <Card title="源码构建参数设置">
        ...
        {(languageType == "nodejsstatic" ||
          ...
          languageType == "Node" ||
          languageType == "node") && (
          <NodeJSConfig languageType={languageType} envs={runtimeInfo} form={this.props.form}/>
        )}
        {(languageType == "NetCore" ||
          languageType == "netCore" ||
          languageType == "netcore") && (
          <NetCoreConfig languageType={languageType} envs={runtimeInfo} form={this.props.form}/>
        )}
