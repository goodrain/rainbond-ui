//共同的信息
    ...
    const button = {
        ...
        'button.close':'Close',
        'guideCarousel.eyebrow':'Guided Tour',
        'guideCarousel.progress':'Progress',
        'guideCarousel.appOverview.components.title':'Component Management',
        'guideCarousel.appOverview.components.titleHint.prefix':'This icon represents the ',
        'guideCarousel.appOverview.components.titleHint.highlight':'component node',
        'guideCarousel.appOverview.components.titleHint.suffix':'. Left-click to enter component details, or right-click to open the quick action menu.',
        'guideCarousel.appOverview.components.leftClick.title':'Left Click (View Details)',
        'guideCarousel.appOverview.components.rightClick.title':'Right Click (Open Menu)',
        'guideCarousel.appOverview.gateway.title':'Gateway Management',
        'guideCarousel.appOverview.gateway.titleHint.prefix':'This icon represents the ',
        'guideCarousel.appOverview.gateway.titleHint.highlight':'gateway node',
        'guideCarousel.appOverview.gateway.titleHint.suffix':'. Left-click to enter gateway management, including routes, certificates, and target services.',
        'guideCarousel.appOverview.gateway.leftClick.title':'Left Click',
        'guideCarousel.appOverview.gateway.rightClick.title':'Right Click (No Action)',
        'button.open':'Open',
    ...
    const confirmModal = {
        ...
        'confirmModal.cluster.unload.title':'Unload the cluster',
        ...
        'appOverview.app.delete.crdImpact':'This application contains CRD(s): {crdNames}. Deletion will cascade to {crCount} custom resource(s), affecting {otherAppCount} other application(s) and {unownedCount} unowned resource(s).',
        'appOverview.app.delete.crdAdminRequired':'The CRD is used by another application or unowned resources. Only an enterprise administrator can cascade the deletion.',
        'appOverview.app.delete.crdCascadeWarning':'Related custom resources and CRDs will be deleted before application components. Custom resources in other applications will also be removed and this cannot be undone.',
        'appOverview.app.delete.crdImpactUnavailable':'Unable to inspect the CRD impact: {reason}. Application deletion is disabled to prevent accidental data loss.',
        'appOverview.app.delete.crdWaitHint':'Related custom resources must be cleaned before their CRDs. Operator recreation or finalizer cleanup may make this take tens of seconds.',
        'appOverview.app.delete.crdDeleting':'Cleaning {crCount} custom resource(s) and {crdCount} CRD(s), and confirming that operators do not recreate them. Do not repeat the operation.',
        'appOverview.app.delete.deletingButton':'Deleting',
        ...
        'confirmModal.unload.cluster.desc':'Are you sure you want to unload this cluster?',
        ...
        'confirmModal.image.lable.domain':'Registry Domain',
        ...
        //添加/修改镜像仓库授权信息    
        'confirmModal.add.common.image.title':'Add Registry',
        ...
        'confirmModal.common.image.tip.access_secret':'Cloud account Secret Access Key, not the registry password. Used to query namespaces, repositories, and image metadata from the cloud provider API.',
    ...
    const notification = {
        ...
        'notification.warn.building':'The component has a task in progress. Please try building again later.',
    ...
    const placeholder = {
        ...
        'placeholder.git_url_domain':'Please enter image-registry domain',
        ...
        'placeholder.dockerRun':'eg: docker run -d -p 8080:8080 -e MYSQL_PASS=123456 mysql',
        'placeholder.yaml_content':'Enter the DockerCompose configuration content',
        'placeholder.user_name':'Please enter the username',
        'placeholder.password':'Please enter the password',
        ...
        'placeholder.secret_keep_current':'Leave blank to keep the current secret',
        ...
        'placeholder.image_registry_domain.docker':'Please enter a registry address, for example: https://docker.io',
        'placeholder.image_registry_domain.harbor':'Please enter a registry address, for example: https://harbor.example.com',
        'placeholder.image_registry_domain.aliyun_acr':'Please enter a registry address, for example: https://registry.cn-hangzhou.aliyuncs.com/',
        'placeholder.image_registry_domain.tencent_tcr':'Please enter a registry address, for example: https://demo-tcr.tencentcloudcr.com',
        'placeholder.image_registry_domain.huawei_swr':'Please enter a registry address, for example: https://swr.cn-north-4.myhuaweicloud.com',
        'placeholder.image_registry_domain.volcano_cr':'Please enter a registry address, for example: https://xxx-cn-shanghai.cr.volces.com',
        ...
        'placeholder.portFrom.invalid_format':'The format is invalid, cannot contain Spaces, Chinese characters, and cannot start with punctuation',
        'applicationMarket.HelmForm.invalid_format':'Please fill in the capital letters'
    }
    const tooltip = {
