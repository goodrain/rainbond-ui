...
export default class AddServiceComponent extends PureComponent {
  ...
  render() {
    ...
    const codeSvg = () => (
      <svg width="80px" height="80px" viewBox="0 0 50 50" version="1.1" >
    ...
    const dockerSvg = () => (
      <svg viewBox="0 0 50 50" version="1.1" width="80px" height="80px">
    ...
    const githubrSvg = () => (
      <svg viewBox="0 0 16 16" version="1.1" width="80px" height="80px">
