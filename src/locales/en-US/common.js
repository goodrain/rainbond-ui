//共同的信息
    ...
    const button = {
        ...
        'guideCarousel.appOverview.components.leftClick.item1':'Component overview: shows the component’s key runtime information.',
        'guideCarousel.appOverview.components.leftClick.item2':'Resource allocation: check whether CPU, memory, and disk resources are sufficient.',
        'guideCarousel.appOverview.components.leftClick.item3':'Logs and monitoring: troubleshoot errors, performance fluctuations, and runtime issues.',
        'guideCarousel.appOverview.components.leftClick.item4':'Environment, dependencies, and advanced settings: adjust variables, relationships, and finer-grained configuration.',
        'guideCarousel.appOverview.components.rightClick.title':'Right Click (Open Menu)',
        'guideCarousel.appOverview.components.rightClick.item1':'Create dependency: connect components so they can access each other.',
        'guideCarousel.appOverview.components.rightClick.item2':'Start, stop, or delete component: operate on components and quickly adjust runtime status.',
        'guideCarousel.appOverview.components.rightClick.item3':'Apply updates: make configuration, image, or version changes take effect quickly.',
        'guideCarousel.appOverview.components.rightClick.item4':'Web terminal: enter the component container directly for online inspection and temporary handling.',
        ...
        'guideCarousel.appOverview.gateway.leftClick.item1':'Application gateway routes: configure domains, paths, and access rules so users can reach the application correctly.',
        'guideCarousel.appOverview.gateway.leftClick.item2':'Application gateway certificates: manage HTTPS certificates for more secure access.',
        'guideCarousel.appOverview.gateway.leftClick.item3':'Application gateway target services: confirm which components external traffic is ultimately forwarded to.',
        'button.open':'Open',
