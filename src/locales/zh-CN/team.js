...
const Vm = {
  ...
  'Vm.createVm.selectLiveMigrationStorage': '请选择支持 live migration 的存储类型',
  'Vm.createVm.noLiveMigrationStorage': '当前团队没有可用于虚拟机 live migration 的共享存储类型',
  'Vm.createVm.noLiveMigrationStorageHint': '这里只展示 access mode 包含 RWX 的存储类型。',
