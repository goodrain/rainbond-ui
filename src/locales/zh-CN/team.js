...
const Vm = {
  ...
  'Vm.createVm.guestOS': '客户机系统',
  'Vm.createVm.guestOSLinux': 'Linux',
  'Vm.createVm.guestOSWindows': 'Windows',
  'Vm.createVm.guestOSRequired': '请选择客户机系统',
  'Vm.createVm.networkMode': '网络模式',
  'Vm.createVm.networkRandom': '随机 IP',
  'Vm.createVm.networkFixed': '固定 IP',
  'Vm.createVm.networkName': '业务网络',
  'Vm.createVm.networkNamePlaceholder': '请选择业务网络',
  'Vm.createVm.fixedIP': '固定 IP',
  'Vm.createVm.fixedIPPlaceholder': '请输入固定 IP，例如 10.250.250.10/24',
  'Vm.createVm.gateway': '网关',
  'Vm.createVm.gatewayPlaceholder': '请输入网关，例如 172.16.20.1',
  'Vm.createVm.dnsServers': 'DNS',
  'Vm.createVm.dnsServersPlaceholder': '请输入 DNS，多个用英文逗号分隔',
  ...
  'Vm.assetCatalog.cloneTitle': '快速复制镜像资产',
  'Vm.assetCatalog.cloneNamePlaceholder': '请输入新的资产名称',
