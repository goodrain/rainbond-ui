...
import { Row, Col, Card, List, Avatar, Form, Input, Select, Button, Icon, Tooltip } from "antd";
...
export default class Index extends PureComponent {
    ...
    //     </div> */}
                <div className={styles.content}>
                    <div className={styles.contentTitle}>{team.team_alias}
                        {/* （ {moment(team.create_time).format("YYYY-MM-DD")}） */}
                    </div>
                    {/* <Row>
        ...
        return (
            <div style={{ margin: '-24px -24px 0',height:"155px",background:"#fff"}} >
                <div className={styles.pageHeaderContent}>
                    <div className={styles.content}>
