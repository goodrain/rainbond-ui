//共同的信息
    ...
    const confirmModal = {
        ...
        'appOverview.app.delete.crdWaitHint':'删除 CR 和 CRD 需要等待 Kubernetes finalizer 完成，通常需要 20–60 秒。',
        'appOverview.app.delete.crdDeleting':'正在删除 {crCount} 个 CR 和 {crdCount} 个 CRD，请勿关闭页面或重复操作。',
