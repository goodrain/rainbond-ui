...
const teamOverview = {
  ...
  'teamOverview.createApp': 'New app',
...
const teamAdd = {
  ...
  'teamAdd.create.code.href':'View the source code',
...
const teamGateway = {
  ...
  'teamGateway.strategy.table.config':'Parameter config',
