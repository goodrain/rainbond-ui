...
import { Row, Col, Button, Table, Card, notification } from 'antd'
...
class Control extends Component {
  ...
  render() {
      ...
      render: (text, record, index) => {
        return (
          <span>
            ...
            {record.issued_by.includes('第三方签发') ? '' : <a style={{ marginRight: "10px" }} onClick={this.handleUpdate.bind(this, record)}>更新</a>}
    ...
    return (
      ...
      >
        <Row>
          <Button type="primary" icon="plus" style={{ float: "right", marginBottom: "10px" }} onClick={this.handleCick}>
            添加证书
          </Button>
        </Row>
        <Card
