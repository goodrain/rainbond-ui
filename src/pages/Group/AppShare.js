...
@connect(({ user, componentControl, loading, enterprise, teamControl }) => ({
...
export default class Main extends PureComponent {
  ...
  getShareInfo() {
    ...
    dispatch({
      type: "componentControl/getShareInfo",
      payload: {
  ...
  fetchRecord = () => {
    ...
    const { dispatch } = this.props;
    dispatch({
      type: "componentControl/fetchShareRecord",
      payload: {
        team_name: teamName,
        app_id: appID,
        record_id: shareId
  ...
  handleSubmit = () => {
    ...
    form.validateFields((err, values) => {
      if (!err) {
        ...
        dispatch({
          type: "componentControl/subShareInfo",
          payload: {
            team_name: teamName,
            share_id: shareId,
