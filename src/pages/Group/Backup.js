...
export default class AppList extends PureComponent {
	...
	handleExport = (data, e) => {
		...
		var exportURl = apiconfig.baseUrl + '/console/teams/' + team_name + '/groupapp/' + group_id + '/backup/export?backup_id=' + backup_id
			...
			<PageHeaderLayout
				...
				extraContent={(
					<div>
						...
						<Button style={{ marginRight: 8 }} onClick={this.toAdd} href="javascript:;">导入备份</Button>
						<Button onClick={this.jumpToAllbackup} href="javascript:;">全部备份</Button>
					</div>
				)}>
				<Card>
					<ScrollerX sm={800}>
