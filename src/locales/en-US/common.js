//共同的信息
    ...
    const confirmModal = {
        ...
        'appOverview.app.delete.crdWaitHint':'Deleting custom resources and CRDs must wait for Kubernetes finalizers and usually takes 20–60 seconds.',
        'appOverview.app.delete.crdDeleting':'Deleting {crCount} custom resource(s) and {crdCount} CRD(s). Do not close the page or repeat the operation.',
