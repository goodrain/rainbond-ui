//共同的信息
    ...
    const button = {
        ...
        'button.last_step':'Previous step',
    ...
    const confirmModal = {
        ...
        'confirmModal.abandon_create.create_check.title':'Give up create',
    ...
    const notification = {
        ...
        'notification.hint.component.putStop':'Operation successful, closing',
         ...
         'notification.hint.confiuration.update.title':'The component that needs to be updated takes effect immediately',
