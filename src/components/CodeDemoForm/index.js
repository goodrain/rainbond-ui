...
export default class Index extends PureComponent {
  constructor(props) {
    ...
    this.state = {
      addGroup: false,
      demoHref: this.props.data.git_url || configureGlobal.documentAddress2048
    };
  }
  onAddGroup = () => {
        ...
        <div>
          <Tag color="magenta" style={{ marginBottom: "10px" }}>
            <a
              target="_blank"
              style={{ color: "#EA2E96" }}
              href={configureGlobal.documentAddress2048}
            >
              2048小游戏
            </a>
          </Tag>
          <Tag color="green" style={{ marginBottom: "10px" }}>
            <a
              ...
              style={{ color: "#74CC49" }}
              href={`${
                configureGlobal.documentAddress
              }goodrain/static-demo.git`}
            >
              静态Web：hello world !
            </a>
          </Tag>
          <Tag color="volcano" style={{ marginBottom: "10px" }}>
            <a
              target="_blank"
              style={{ color: "#FA541B" }}
              href={`${configureGlobal.documentAddress}goodrain/php-demo.git`}
            >
              PHP Demo
            </a>
          </Tag>
          ...
          <Tag color="gold" style={{ marginBottom: "10px" }}>
            <a
              target="_blank"
              style={{ color: "#FCAD15" }}
              href={`${configureGlobal.documentAddress}goodrain/go-demo.git`}
            >
              Golang Demo
            </a>
          </Tag>
      ...
      <Form layout="horizontal" hideRequiredMark>
        ...
        >
          {getFieldDecorator("git_url", {
            initialValue: data.git_url || configureGlobal.documentAddress2048,
            rules: [{ required: true, message: "请选择" }]
          })(
            <Select
              style={{ display: "inline-block", width: 292, marginRight: 15 }}
            ...
            >
              <Option value={configureGlobal.documentAddress2048}>
                2048小游戏
              </Option>
              <Option
                value={`${
              ...
              <Option
                value={`${configureGlobal.documentAddress}goodrain/go-demo.git`}
              >
                Golang Demo
              </Option>
              <Option
