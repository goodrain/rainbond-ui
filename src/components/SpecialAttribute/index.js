...
export default class SpecialAttribute extends PureComponent {
    ...
    render() {
        ...
        return (
            <Card title={formatMessage({id:'enterpriseColony.import.recognition.tabs.specialAttr'})} style={{ marginBottom: '10px' ,  borderRadius: 5, boxShadow:'rgb(36 46 66 / 16%) 2px 4px 10px 0px'}}>
