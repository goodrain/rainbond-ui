...
const teamGateway = {
  ...
  // NewGateway
  'teamNewGateway.NewGateway.index.management':'Routing management',
  'teamNewGateway.NewGateway.index.Services':'Target Services',
  'teamNewGateway.NewGateway.index.certificate':'Certificate Management',
  'teamNewGateway.NewGateway.GatewayRoute.name':'Name',
  'teamNewGateway.NewGateway.GatewayRoute.host':'Domain name',
  'teamNewGateway.NewGateway.GatewayRoute.path':'Path',
  'teamNewGateway.NewGateway.GatewayRoute.service':'Target Services',
  'teamNewGateway.NewGateway.GatewayRoute.senior':'Senior',
  ...
  'teamNewGateway.NewGateway.RouteDrawer.method':'Please select Method',
  'teamNewGateway.NewGateway.RouteDrawer.IP':'source IP',
  'teamNewGateway.NewGateway.RouteDrawer.InputIP':'Please enter the source IP',
  'teamNewGateway.NewGateway.RouteDrawer.Advanced':'Advanced conditions',
  'teamNewGateway.NewGateway.RouteDrawer.InputAdvanced':'Please fill in the advanced conditions',
  'teamNewGateway.NewGateway.RouteDrawer.priority':'priority',
  'teamNewGateway.NewGateway.RouteDrawer.InputPriority':'Please fill in the priority',
  'teamNewGateway.NewGateway.RouteDrawer.source':'Service source',
  'teamNewGateway.NewGateway.RouteDrawer.default':'default',
  'teamNewGateway.NewGateway.RouteDrawer.senior':'senior',
  'teamNewGateway.NewGateway.RouteDrawer.name':'Service Name:',
  'teamNewGateway.NewGateway.RouteDrawer.port':'Port number:',
  'teamNewGateway.NewGateway.RouteDrawer.service':'Target Services',
  'teamNewGateway.NewGateway.RouteDrawer.InputService':'Please fill in the target service',
  'teamNewGateway.NewGateway.GatewayService.address':'Service address',
  'teamNewGateway.NewGateway.ServiceDrawer.add':'Add target service',
  'teamNewGateway.NewGateway.ServiceDrawer.name':'Please fill in the service name',
  ...
  'teamNewGateway.NewGateway.ServiceDrawer.InputHost':'Please fill in the target host',
  'teamNewGateway.NewGateway.ServiceDrawer.RequestHeader':'Host Request Header',
  'teamNewGateway.NewGateway.ServiceDrawer.IP':'Use target IP',
  'teamNewGateway.NewGateway.ServiceDrawer.unchanged':'remain unchanged',
  'teamNewGateway.NewGateway.ServiceDrawer.Host':'Specify Host',
  'teamNewGateway.NewGateway.ServiceDrawer.InputHosts':'Please fill in the specified Host.',
  'teamNewGateway.NewGateway.ServiceDrawer.protocol':'Protocol',
  'teamNewGateway.NewGateway.ServiceDrawer.send':'Send',
  'teamNewGateway.NewGateway.ServiceDrawer.sentime':'Send time',
  'teamNewGateway.NewGateway.ServiceDrawer.accept':'Accept',
  'teamNewGateway.NewGateway.ServiceDrawer.accepttime':'Accept time',
  'teamNewGateway.NewGateway.ServiceDrawer.connect':'Connect',
  'teamNewGateway.NewGateway.ServiceDrawer.connecttime':'Connection time',
  ...
  'teamNewGateway.NewGateway.ServiceDrawer.selectType':'Please select the type of load balancing',
  'teamNewGateway.NewGateway.ServiceDrawer.value':'value',
  'teamNewGateway.NewGateway.ServiceDrawer.selectValue':'Please select a value',
  'teamNewGateway.NewGateway.GatewayRoute.edit': 'Edit Route',
  'teamNewGateway.NewGateway.RouteDrawer.addServe': 'Add target service',
  'teamNewGateway.NewGateway.RouteDrawer.Plugin': 'Cancel Add',
  'teamNewGateway.NewGateway.RouteDrawer.addPlugin': 'Add plugins',
  'teamNewGateway.NewGateway.ServiceDrawer.creat':'Create target service',
  'teamNewGateway.NewGateway.ServiceDrawer.edit':'Editing service',
  'teamNewGateway.NewGateway.TCP.address': 'Listening address',
  'teamNewGateway.NewGateway.TCP.service': 'Target Services',
  'teamNewGateway.NewGateway.TCP.type': 'Protocol type',
  'teamNewGateway.NewGateway.TCP.handle': 'Operation',
  'teamNewGateway.NewGateway.TCP.add': 'Add TCP routing',
  'teamNewGateway.NewGateway.TCP.edit': 'Edit TCP routing',
  'teamNewGateway.NewGateway.TCP.port': 'Port number',
  'teamNewGateway.NewGateway.TCP.inputPort': 'Please fill in the port number',
  'teamNewGateway.NewGateway.TCP.selectService': 'Select Services',
  'teamNewGateway.NewGateway.TCP.name': 'Service Name:',
  'teamNewGateway.NewGateway.TCP.ports': 'Port number:',
}
