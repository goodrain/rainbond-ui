...
const componentOther = {
    ...
    'componentOverview.body.LoadBalancer.service_name': '服务名称',
    'componentOverview.body.LoadBalancer.backend_service': '后端服务',
    ...
    'componentOverview.body.LoadBalancer.annotations_description': '用于配置云提供商特定功能，如AWS NLB、Azure内部负载均衡器等',
