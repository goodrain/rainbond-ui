...
export default class AddThirdParty extends PureComponent {
  ...
  //上一步
  handleBackEvents = () => {
    const {ServiceComponentTwoPage, ServiceComponentThreePage, BackType } = this.state;
      ...
      <svg width="60px" height="60px" viewBox="0 0 41 27" version="1.1">
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          <g id="Group-2" transform="translate(-9.000000, -17.000000)">
            ...
            <rect id="Rectangle" fill="#326DE6" x="9" y="17" width="41" height="27" rx="3"></rect>
            <text id="API" font-family="Helvetica-Bold, Helvetica" font-size="16" font-weight="bold" fill="#FFFFFF">
              <tspan x="16" y="36">API</tspan>
            </text>
          </g>
        </g>
      </svg>
      ...
      <svg width="60px" height="60px" viewBox="0 0 36 47" version="1.1" >
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          <g id="Group" transform="translate(-12.000000, -7.000000)">
            ...
            <polygon id="Path" fill="#326DE6" fill-rule="nonzero" points="35.7884651 7 12 7 12 54 48 54 48 19.4644"></polygon>
            <path d="M18.8333333,17 L27.1666667,17 C27.6266667,17 28,17.447 28,18 C28,18.553 27.6266667,19 27.1666667,19 L18.8333333,19 C18.3733333,19 18,18.553 18,18 C18,17.447 18.3733333,17 18.8333333,17 Z" id="Path" fill="#FFFFFF" fill-rule="nonzero"></path>
            <path d="M40.1481481,46 L18.8518519,46 C18.3816296,46 18,45.553 18,45 C18,44.447 18.3816296,44 18.8518519,44 L40.1481481,44 C40.6183704,44 41,44.447 41,45 C41,45.553 40.6183704,46 40.1481481,46 Z" id="Path" fill="#FFFFFF" fill-rule="nonzero"></path>
            <path d="M40.1481481,40 L18.8518519,40 C18.3816296,40 18,39.553 18,39 C18,38.447 18.3816296,38 18.8518519,38 L40.1481481,38 C40.6183704,38 41,38.447 41,39 C41,39.553 40.6183704,40 40.1481481,40 Z" id="Path" fill="#FFFFFF" fill-rule="nonzero"></path>
            <path d="M40.1481481,33 L18.8518519,33 C18.3816296,33 18,32.553 18,32 C18,31.447 18.3816296,31 18.8518519,31 L40.1481481,31 C40.6183704,31 41,31.447 41,32 C41,32.553 40.6183704,33 40.1481481,33 Z" id="Path" fill="#FFFFFF" fill-rule="nonzero"></path>
            <polygon id="Path" fill="#FFFFFF" fill-rule="nonzero" points="35 21 35 9 47 21"></polygon>
          </g>
        </g>
      </svg>
    );
    ...
    return (
      <div>
        ...
        >
          ...
          {(ServiceComponentTwoPage === "outerCustom") && <OuterCustom
            groupId={this.props.groupId}
            handleType="Service"
          ...
          >
            {!ServiceComponentTwoPage && ServiceComponentThreePage !== "check" && <Button
              style={{
                marginRight: 8,
              }}
