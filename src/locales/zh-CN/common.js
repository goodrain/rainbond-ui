//共同的信息
    ...
    const button = {
        ...
        'button.close':'关闭',
        'guideCarousel.eyebrow':'新手引导',
        'guideCarousel.progress':'当前进度',
        'guideCarousel.appOverview.components.title':'组件管理',
        'guideCarousel.appOverview.components.titleHint.prefix':'图标代表 ',
        'guideCarousel.appOverview.components.titleHint.highlight':'组件节点',
        'guideCarousel.appOverview.components.titleHint.suffix':'。左键点击进入组件详情，右键点击可打开快捷操作菜单。',
        'guideCarousel.appOverview.components.leftClick.title':'鼠标左键(进入详情)',
        'guideCarousel.appOverview.components.rightClick.title':'鼠标右键（建立依赖）',
        'guideCarousel.appOverview.gateway.title':'网关管理',
        'guideCarousel.appOverview.gateway.titleHint.prefix':'图标代表 ',
        'guideCarousel.appOverview.gateway.titleHint.highlight':'网关节点',
        'guideCarousel.appOverview.gateway.titleHint.suffix':'。左键进入网关管理，路由、证书和目标服务。',
        'guideCarousel.appOverview.gateway.leftClick.title':'鼠标左键(网关管理)',
        'guideCarousel.appOverview.gateway.rightClick.title':'鼠标右键（当前无操作）',
        'button.open':'开通',
        'button.submit':'提交',
    ...
    const confirmModal = {
        ...
        'confirmModal.cluster.unload.title':'卸载集群',
        ...
        'appOverview.app.delete.crdImpact':'该应用包含 CRD：{crdNames}。删除后将级联删除 {crCount} 个 CR，涉及其他应用 {otherAppCount} 个、未归属 CR {unownedCount} 个。',
        'appOverview.app.delete.crdAdminRequired':'上述 CRD 被其他应用或未归属资源使用，仅企业管理员可以级联删除。',
        'appOverview.app.delete.crdCascadeWarning':'确认后将先删除关联 CR 和 CRD，再删除应用组件；其他应用中的相关 CR 也会被删除，此操作不可恢复。',
        'appOverview.app.delete.crdImpactUnavailable':'暂时无法确认 CRD 影响范围：{reason}。为避免误删，当前不能继续删除应用。',
        'appOverview.app.delete.crdWaitHint':'删除 CRD 前需要先清理关联 CR；如果存在 Operator 自动重建或 finalizer 清理，过程可能需要几十秒。',
        'appOverview.app.delete.crdDeleting':'正在清理 {crCount} 个 CR 和 {crdCount} 个 CRD，并确认资源不会被 Operator 重新创建，请勿重复操作。',
        'appOverview.app.delete.deletingButton':'删除中',
        ...
        'confirmModal.unload.cluster.desc':'确定要卸载此集群吗？',
        ...
        'confirmModal.app.govern.alert.msg':'应用治理模式主要指组件间通信模式的治理，默认支持Kubernetes原生Service模式。',
    ...
    const placeholder = {
        ...
        'placeholder.docker_cmd':'请输入镜像地址 例如: registry.cn-hangzhou.aliyuncs.com/goodrain/nginx:alpine',
        'placeholder.dockerRunMsg':'请输入DockerRun命令',
        'placeholder.helmCmdMsg':'请输入 Helm 命令',
        'placeholder.dockerRun':'例如： docker run --name mysql -e MYSQL_ROOT_PASSWORD=Pa88Word -d registry.cn-hangzhou.aliyuncs.com/goodrain/mysql:5.7.42',
        ...
        'placeholder.image_registry_domain.docker':'请输入仓库地址，如：https://docker.io',
        'placeholder.image_registry_domain.harbor':'请输入仓库地址，如：https://harbor.example.com',
        'placeholder.image_registry_domain.aliyun_acr':'请输入仓库地址，如：https://registry.cn-hangzhou.aliyuncs.com/',
        'placeholder.image_registry_domain.tencent_tcr':'请输入仓库地址，如：https://demo-tcr.tencentcloudcr.com',
        'placeholder.image_registry_domain.huawei_swr':'请输入仓库地址，如：https://swr.cn-north-4.myhuaweicloud.com',
        'placeholder.image_registry_domain.volcano_cr':'请输入仓库地址，如：https://xxx-cn-shanghai.cr.volces.com',
