...
const teamAdd = {
  ...
  'teamAdd.create.code.address':'Git repo address',
  'teamAdd.create.code.versions':'Code version',
  'teamAdd.create.code.branch':'Branch',
  'teamAdd.create.code.fillInUser':'Fill in the username and password',
  ...
  'teamAdd.create.image.hint2':'Fill in the repository username and password',
  'teamAdd.create.image.mirrorAddress':'Image address',
