const deviceAuthorization = {
  'deviceAuthorization.title': 'Connect Rainskills',
  'deviceAuthorization.subtitle': 'Confirm this Rainbond MCP access request.',
  'deviceAuthorization.code.label': 'Device code',
  'deviceAuthorization.code.continue': 'Continue',
  'deviceAuthorization.client': 'Requested by',
  'deviceAuthorization.account': 'Current account',
  ...
  'deviceAuthorization.result.approved.title': 'Authorization complete',
  'deviceAuthorization.result.approved.detail': 'Your terminal will continue automatically. You can close this page.',
