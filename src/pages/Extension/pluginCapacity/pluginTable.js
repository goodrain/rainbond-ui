    ...
    constructor(props) {
        ...
        this.state = {
            ...
            defaultPluginList: [
                ...
                {
                    "alias": "Rainbond—Spring Cloud可视化管理",
                    "icon": "springCloud",
                        ...
                        {defaultPluginList.map((item) => {
                            ...
                            return (
                                <div className={styles.boxs}>
                                    ...
                                    <Col span={2}>
                                        <a href='https://www.rainbond.com/enterprise_server' target="_blank" >
                                            联系我们
                                        </a>
                                    </Col>
                                </div>
