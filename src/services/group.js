...
export async function getBackupStatus(
  ...
  return request(
    `${config.baseUrl}/console/teams/${body.team_name}/groupapp/${
      body.group_id
    }/backup`,
    {
      method: "get",
...
export async function getBackup(body = { team_name, group_id }) {
  return request(
    `${config.baseUrl}/console/teams/${body.team_name}/groupapp/backup`,
    {
      method: "get",
      params: {
...
export async function queryAllBackup(param) {
  return request(
    `${config.baseUrl}/console/teams/${param.team_name}/all/groupapp/backup`,
    {
      method: "get",
      params: {
...
export async function queryRestoreState(param) {
  return request(
    `${config.baseUrl}/console/teams/${param.team_name}/groupapp/${
      param.group_id
    }/migrate/record`,
    {
      method: "get",
...
export async function getGroupDetail(
  ...
  return request(
    `${config.baseUrl}/console/teams/${body.team_name}/groups/${body.group_id}`,
    {
      handleError
    }
  );
...
export async function getGroupApps(
  ...
  return request(
    `${config.baseUrl}/console/teams/${body.team_name}/service/group`,
    {
      method: "get",
      params: {
        group_id: body.group_id,
...
export async function giveupShare(
  ...
  return request(
    `${config.baseUrl}/console/teams/${body.team_name}/share/${
      body.share_id
    }/giveup`,
    { method: "delete" }
  );
...
/*
	查询需要分享应用记录信息
*/
export async function getShareAppRecord(
  body = {
    team_name,
    group_key
  }
