...
const Vm = {
  ...
  'Vm.createVm.guestOS': 'Guest OS',
  'Vm.createVm.guestOSLinux': 'Linux',
  'Vm.createVm.guestOSWindows': 'Windows',
  'Vm.createVm.guestOSRequired': 'Please select a guest OS',
  'Vm.createVm.networkMode': 'Network Mode',
  'Vm.createVm.networkRandom': 'Random IP',
  'Vm.createVm.networkFixed': 'Fixed IP',
  'Vm.createVm.networkName': 'Business Network',
  'Vm.createVm.networkNamePlaceholder': 'Please select a business network',
  'Vm.createVm.fixedIP': 'Fixed IP',
  'Vm.createVm.fixedIPPlaceholder': 'Enter a fixed IP, for example 10.250.250.10/24',
  'Vm.createVm.gateway': 'Gateway',
  'Vm.createVm.gatewayPlaceholder': 'Enter a gateway, for example 172.16.20.1',
  'Vm.createVm.dnsServers': 'DNS Servers',
  'Vm.createVm.dnsServersPlaceholder': 'Enter DNS servers separated by commas',
  ...
  'Vm.assetCatalog.cloneTitle': 'Quick Copy Image Asset',
  'Vm.assetCatalog.cloneNamePlaceholder': 'Enter a new asset name',
