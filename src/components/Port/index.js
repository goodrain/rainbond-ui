                    ...
                    return <div>
                      {
                        <p>
                          {domain.protocol == "http" || domain.protocol == "https" ?
                            <a href={'http://' + domain.end_point.replace(/\s+/g, "")} target="blank">{domain.end_point}</a> :
                            <a href="javascript:void(0)" onClick={this.resolveNotHttp.bind(this, domain)}>{domain.end_point}</a>
                          }
                        </p>
                      }
                    </div>
